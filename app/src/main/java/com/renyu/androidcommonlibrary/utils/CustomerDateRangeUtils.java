...
public class CustomerDateRangeUtils {
    // 周期起始时间
    ...
    private LoopView pop_wheel_datarangelayout_year;
    private LoopView pop_wheel_datarangelayout_month;
    private LoopView pop_wheel_datarangelayout_day;


    public CustomerDateRangeUtils(long startTime, long endTime, boolean isNeedHM) {
    ...
    public void showDateRange(View view) {
        ...
        pop_wheel_datarangelayout_year = view.findViewById(R.id.pop_wheel_datarangelayout_year);
        pop_wheel_datarangelayout_month = view.findViewById(R.id.pop_wheel_datarangelayout_month);
        pop_wheel_datarangelayout_day = view.findViewById(R.id.pop_wheel_datarangelayout_day);
        ...
        if (special) {
            ...
            for (int i = 1; i <= dayCount - day_start + 1; i++) {
                ...
                days.put(i, "" + (value < 10 ? "0" + value : value) + " ");
            }
        } else {
    ...
    public String getResult() {
        ...
        return years.get(pop_wheel_datarangelayout_year.getSelectedItem()) + "-"
