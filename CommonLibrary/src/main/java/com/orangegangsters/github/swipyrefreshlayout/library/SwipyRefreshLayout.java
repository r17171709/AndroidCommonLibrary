...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    public boolean canChildScrollDown() {
        ...
        if (mTarget instanceof RecyclerView) {
            ...
            if (layoutManager instanceof VirtualLayoutManager && count > 0) {
                VirtualLayoutManager linearLayoutManager = (VirtualLayoutManager) layoutManager;
                //获取第最后一个可见view的位置
                if (linearLayoutManager.findLastCompletelyVisibleItemPosition() == count - 1) {
                    return true;
                }
            }
            else if (layoutManager instanceof LinearLayoutManager && count > 0) {
